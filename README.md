# Async Rust PCA9685 16-channel 12-bit I2C PWM/Servo/LED driver

This is a platform agnostic async Rust driver for the PCA9685 PWM/Servo/LED
controller, based on the [`embedded-hal-async`] traits.
